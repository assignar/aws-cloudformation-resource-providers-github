...
1. Write the JSON schema describing your resource, `github-repository-environment.json`
2. Implement your resource handlers in `github_repository_environment/handlers.py`
