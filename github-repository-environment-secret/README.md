...
1. Write the JSON schema describing your resource, `github-repository-environmentsecret.json`
2. Implement your resource handlers in `github_repository_environmentsecret/handlers.py`
